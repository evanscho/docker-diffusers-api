...
# Synced to commit 0b8e29289dd97805f778922c98a13cd0700d3ab3 on 2024-03-27
...
def main(args, init_pipeline, status_update_options):  # DDA
            ...
            for step, batch in enumerate(train_dataloader):
                with accelerator.accumulate(unet):
                    ...
                    if args.snr_gamma is None:
                        ...
                        base_weight = (
                            torch.stack([snr, args.snr_gamma * torch.ones_like(timesteps)],
                ...
                if accelerator.sync_gradients:
                    ...
                    # ESS: Update event timing tracker if streaming result
                    if status_instance:
    ...
    if accelerator.is_main_process:
        ...
        pipeline = DiffusionPipeline.from_pretrained(
            ...
            variant=args.variant,
            **pipeline_args,
            # local_files_only=True,  # DDA  # ESS: temporarily disable due to error "OSError: We couldn't connect to 'https://huggingface.co' to load this model, couldn't find it in the cached files and it looks like /root/.cache/huggingface/hub/models--runwayml--stable-diffusion-v1-5/snapshots/1d0c4ebf6ff58a5caecab40fa1406526bca4b5b9/model_index.json is not the path to a directory containing a model_index.json file."
        )
